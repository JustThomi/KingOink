...
class Spritesheet:
    ...
    def fetch_frame(self, current_frame, row = 0):
...
class TerrainTiles:
    def __init__(self) -> None:
        self.background_tileset = Spritesheet(pygame.image.load(os.path.join('assets', 'environment', 'terrain.png')), (32, 32))
        ...
        self.background = {
            ...
            'I': self.background_tileset.fetch_frame(3, 8),
            }
